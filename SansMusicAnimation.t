...
setscreen ("graphics")
    ...
    %Title and Health Bar text
    Draw.Text ("Undertale", 10, 390, defFontID, white)
    Draw.Text ("Health Bar:", 10, 370, defFontID, white)
    %End of Title and Health Bar text
    %Health Bar animation
    for health : 1..500
        delay (5)
        drawline (100+health, 370, 100+health, 376, white)
    end for
    %End of Health Bar animation
    %ChatBox animation
    for l : 1 .. 620
        delay (5)
    ...
    %End of Title and Health Bar text
    %Health Bar
    drawfillbox (100, 370, 600, 376, white)
    %End of Health Bar
    % Head
    ...
    Draw.Text ("Sans:", 12, 100, defFontID, white)
    Draw.Text ("You feel like you're going to have a bad time.", 12, 90, defFontID, white)
    %End of Chatbox
    %-----------------------------------------------------------------------------End of Frame 1
    delay (500)
    cls
...
process playMusic
    Music.PlayFile("SansMusic.MP3") %Music File
end playMusic
